...
final class Version20241113210343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT AUTO_INCREMENT NOT NULL, séance_id INT NOT NULL, date DATE NOT NULL, heure_Debut TIME NOT NULL, heure_fin TIME NOT NULL, note VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
